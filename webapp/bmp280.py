...
# ==================================================
# File : bmp280.py
# Desc : Read data from bmp dig pressure sensor
# ==================================================
...
def getShort(data, index):
    # return 2 butes from data as a signed 16-bit value
    return c_short((data[index+1] << 8) + data[index]).value


def getUShort(data, index):
    # return 2 bytes from data as an unsigned 16-bit value
    return (data[index+1] << 8) + data[index]

def getChar(data, index):
    # return 1 byte from data as a signed char
    result = data[index]
    if result > 127:
        result -= 256
    return result
...
def getUChar(data, index):
    # return 1 byte from data as an unsigned char
...
# ====================================================
    ...
    def readBMP280All(self, addr=DEVICE):
        ...
        # Read blocks of calibration data from EEPROM - p. 22 of datasheet
        ...
        # convert byet data to word values
...
def main():
    ...
    # read the sensor temp/pres values
